...
$formAction = isset($formAction) ? (string) $formAction : '?route=departments/create';
			...
			<form method="POST" action="<?php echo htmlspecialchars($formAction, ENT_QUOTES, 'UTF-8'); ?>" class="user-create-form">
				...
				<div class="user-create-action-bar">
					...
					<div class="user-create-actions">
						<a href="?route=departments" class="user-create-btn user-create-btn-secondary">Back to Department List</a>
