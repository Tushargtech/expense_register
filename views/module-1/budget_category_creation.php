...
$formAction = isset($formAction) ? (string) $formAction : '?route=budget-categories/create';
			...
			<form method="POST" action="<?php echo htmlspecialchars($formAction, ENT_QUOTES, 'UTF-8'); ?>" class="user-create-form">
					...
					<div class="user-create-grid">
						...
						<div class="user-create-field">
							...
							<select class="user-create-select" id="budget_category_type" name="budget_category_type" required>
								...
								<option value="expense" <?php echo strtolower($selectedType) === 'expense' ? 'selected' : ''; ?>>Expense</option>
								<option value="purchase" <?php echo strtolower($selectedType) === 'purchase' ? 'selected' : ''; ?>>Purchase</option>
							</select>
						</div>
				...
				<div class="user-create-action-bar">
					...
					<div class="user-create-actions">
						<a href="?route=budget-categories" class="user-create-btn user-create-btn-secondary">Back to Category List</a>
