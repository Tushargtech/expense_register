				...
				<section class="user-create-section">
					...
					<div class="user-create-grid">
						...
						<div class="user-create-field">
							...
							<input type="text" maxlength="3" pattern="[A-Za-z]{3}" class="user-create-input" id="request_currency" name="request_currency" value="<?php echo htmlspecialchars($selectedCurrency, ENT_QUOTES, 'UTF-8'); ?>" <?php echo $isReadOnly ? 'readonly' : 'required'; ?>>
						</div>
										...
										<tr>
											...
											<td class="text-end">
												<?php if ($isAttachmentAvailable): ?>
													<a class="btn btn-sm btn-outline-secondary" target="_blank" rel="noopener" href="?route=expenses/attachment/view&request_id=<?php echo (int) ($expense['request_id'] ?? 0); ?>&attachment_id=<?php echo (int) ($attachment['attachment_id'] ?? 0); ?>">View</a>
													<a class="btn btn-sm btn-primary" href="?route=expenses/attachment/download&request_id=<?php echo (int) ($expense['request_id'] ?? 0); ?>&attachment_id=<?php echo (int) ($attachment['attachment_id'] ?? 0); ?>">Download</a>
												<?php else: ?>
