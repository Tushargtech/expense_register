        ...
        <div class="card page-card">
            <div class="card-body p-4 p-md-5">
                ...
                <div class="d-flex gap-2 flex-wrap">
                    <?php if ($isLoggedIn): ?>
                        <a href="<?php echo htmlspecialchars(buildCleanRouteUrl('dashboard'), ENT_QUOTES, 'UTF-8'); ?>" class="btn btn-primary">Go To Dashboard</a>
                    <?php else: ?>
                        <a href="<?php echo htmlspecialchars(buildCleanRouteUrl('dashboard'), ENT_QUOTES, 'UTF-8'); ?>" class="btn btn-primary">Go To Login</a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
