...
class DepartmentController
{
	...
	public function create(): void
	{
		...
		$isEdit = false; // Flag indicating this is create mode, not edit mode
		$formAction = '?route=departments/create'; // POST target for create form
	...
	public function edit(): void
	{
		...
		$activeMenu = 'department-list';
		$formError = trim((string) ($_GET['error'] ?? ''));
		$isEdit = true; // Flag indicating this is edit mode, not create mode
		$formAction = '?route=departments/edit&id=' . $deptId; // POST target for edit form
